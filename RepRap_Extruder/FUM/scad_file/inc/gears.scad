...
translate ([0,0,0]) difference(){
	...
	translate([0,10,8.6]) rotate([-90,0,180]) union()
	{
		...
		translate([0,-3,14.5]) cube([5.8,6,3],center=true);
...
//		translate([0,0,13]) rotate([0,0,0])cylinder(r=5.8/sqrt(3),h=3,$fn=6);
		//grub hole
//		translate([0,0,9]) cylinder(r=3.3/sqrt(3),h=10,$fn=16);

		//nut
		translate([0,-1.5+0.75-0.6,13]) rotate([0,0,90])cylinder(r=5.8/sqrt(3),h=3,$fn=6);
		//grub hole
		translate([0,-1.5+0.75-0.6,9]) cylinder(r=1.5,h=10,$fn=16);
// 3D Andy - end	
...
difference(){
	...
	translate([0,0,2.5]) cylinder(h=7, r=11/sqrt(5),$fn=6);
	cylinder(r=5.3/2,h=40,center=true);
	difference(){
		cylinder(r=22,h=20);
		cylinder(r=7.5,h=20);
		for(i=[0:5])
