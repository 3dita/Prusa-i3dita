...
use <inc/miniFALAexVer06_monojHead2.2.scad>
...
//rotate([0,0,90]) translate([22,14,-55]) cube([7.5,5,16.6]);
//rotate([0,0,90]) translate([22,14,-42.6]) cube([37.5,5,6.6]);
//translate([-32,18.3,-55]) cube([31,4,19]);
//translate([-32,13,-55]) cube([31,4,19]);
//translate([-32,7.5,-55]) cube([31,3,19]);